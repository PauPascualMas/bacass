...
- [nf-core/bacass: Output](#nf-corebacass-output)
  ...
  - [Reads QC and Sample purity](#reads-qc-and-sample-purity)
  - [Assembly Output](#assembly-output)
    - [Polished assemblies](#polished-assemblies)
  - [Assembly QC with QUAST, BUSCO and gfastats](#assembly-qc-with-quast-busco-and-gfastats)
...
## Assembly QC with QUAST, BUSCO and gfastats
...
It also runs [BUSCO](https://busco.ezlab.org/), a software which assess genome quality based on the presence of lineage-specific single-copy orthologs and [gfastats](https://github.com/vgl-hub/gfastats), which provides assembly summary statistics.
...
- `gfastats/`
  - `<AssemblyName>.assembly_summary`: plain text assembly statistics generated by gfastats
